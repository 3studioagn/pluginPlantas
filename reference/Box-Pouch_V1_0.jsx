...
function desenharBoxPouch_Completo(compMM, largMM, sanfMM, ziperAtivo, ziperDistMM) {
    ...
    // --- Sanfonas: Refile + sanfonas + Cameron + Fotocélulas no mesmo grupo ---
    var groupSanfTop = groupSanfonas.groupItems.add(); groupSanfTop.name = "Sanfonas";

    // Refile dentro do grupo, vai para o fundo
    ...
    refileTopRect.zOrder(ZOrderMethod.SENDTOBACK);
    ...
    matBot.zOrder(ZOrderMethod.SENDTOBACK);

    // --- Frente | Verso | Fundo — Refile, Cameron e Fotocélulas dentro deste grupo ---
    ...
    refileBotRect.zOrder(ZOrderMethod.SENDTOBACK);
    ...
    // Cameron dentro do grupo Frente | Verso | Fundo
    ...
    // Fotocélulas dentro do grupo Frente | Verso | Fundo
